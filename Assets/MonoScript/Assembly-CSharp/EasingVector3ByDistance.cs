...
public class EasingVector3ByDistance
{
	...
	public EasingVector3ByDistance(EasingVector3ByDistanceData data)
	{
		m_data = data;
	...
	public Vector3 Run(float currentDistance)
	{
		m_currentDistance = currentDistance;
		return Easing.EasingVector3(Progress(currentDistance), m_data.m_from, m_data.m_to, 1f, m_data.m_easeType);
	}
