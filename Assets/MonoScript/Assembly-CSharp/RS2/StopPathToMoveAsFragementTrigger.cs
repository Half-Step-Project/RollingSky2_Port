...
namespace RS2
{
	public class StopPathToMoveAsFragementTrigger : BaseTriggerBox
	{
		[Serializable]
		public struct StopPathToMoveAsFragementTriggerData : IReadWriteBytes
		{
		...
		public StopPathToMoveAsFragementTriggerData m_data;
		...
		{
			m_data = JsonUtility.FromJson<StopPathToMoveAsFragementTriggerData>(info);
		}

		public override void ReadBytes(byte[] bytes)
		{
			m_data = StructTranslatorUtility.ToStructure<StopPathToMoveAsFragementTriggerData>(bytes);
		}
		...
		{
			m_data = (StopPathToMoveAsFragementTriggerData)objs[0];
		}
