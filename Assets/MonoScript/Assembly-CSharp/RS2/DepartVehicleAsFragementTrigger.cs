...
namespace RS2
{
	public class DepartVehicleAsFragementTrigger : BaseTriggerBox
	{
		[Serializable]
		public struct DepartVehicleAsFragementTriggerData : IReadWriteBytes
		{
		...
		public DepartVehicleAsFragementTriggerData m_data;
		...
		{
			m_data = JsonUtility.FromJson<DepartVehicleAsFragementTriggerData>(info);
		}

		public override void ReadBytes(byte[] bytes)
		{
			m_data = StructTranslatorUtility.ToStructure<DepartVehicleAsFragementTriggerData>(bytes);
		}
		...
		{
			m_data = (DepartVehicleAsFragementTriggerData)objs[0];
		}
