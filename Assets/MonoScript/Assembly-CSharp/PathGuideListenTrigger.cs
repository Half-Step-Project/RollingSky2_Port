...
public class PathGuideListenTrigger : BaseTriggerBox
{
	[Serializable]
	public struct Data
	{
	...
	public override void Initialize()
	{
		...
		mIsListenGroup = false;
		commonState = CommonState.None;
	}

	public override void UpdateElement()
	{
		if (!_insideGameDataModule.GuideLine || !mIsListenGroup)
		{
			return;
		}
	...
	{
		base.ResetElement();
		Mod.Event.Unsubscribe(EventArgs<PathGuideSendEventArgs>.EventId, OnListenEvent);
	...
	{
		PathGuideSendEventArgs pathGuideSendEventArgs = e as PathGuideSendEventArgs;
		if (pathGuideSendEventArgs == null)
		{
			return;
		}
		GroupsSendData data = pathGuideSendEventArgs.Data;
		for (int i = 0; i < data.groupIDs.Count; i++)
		{
			if (data.groupIDs[i] == mData.groupId)
			{
				mIsListenGroup = true;
				break;
			}
	...
	public override object RebirthWriteData()
	{
		...
		rebirthData.isListenGroup = mIsListenGroup;
	...
	public override void RebirthReadData(object rdData)
	{
		...
		if (_rebirthData != null)
		{
			...
			mIsListenGroup = _rebirthData.isListenGroup;
