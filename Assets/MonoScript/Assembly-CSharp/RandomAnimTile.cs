...
public class RandomAnimTile : BaseTile
{
	[Serializable]
	...
	public override void Initialize()
	{
		...
		RandomTileTrigger element = null;
		MapController.Instance.TryGetElementByUUID<RandomTileTrigger>(data.TriggerUuid, out element);
		if (element != null)
		{
			...
			base.transform.position = StartPos + new Vector3(data.RandomItems[SelectIndex].ItemDeltaPosX, 0f, 0f);
