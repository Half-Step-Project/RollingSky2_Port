...
public class ShopUINormalProductItem : UIProductItem
{
	...
	public override void OnInit(object userData)
	{
		...
		{
			m_assetButtonHandler.SetAssetData(m_productData.m_productGoodsTable);
		}
	}
	...
	private void OnBuy()
	{
		...
		if (m_productData.m_shopTable.BuyType == 2)
		{
			if (m_productData.m_shopTable.Type == 11)
			{
				InfocUtils.Report_rollingsky2_games_currency(m_productData.m_productGoodsTable.Id, 1, 14, 0, m_productData.m_shopTable.Id);
			}
			else if (m_productData.m_shopTable.Type == 12)
			{
				InfocUtils.Report_rollingsky2_games_currency(m_productData.m_productGoodsTable.Id, 1, 15, 0, m_productData.m_shopTable.Id);
			}
		}
	}
