...
namespace Mono.Xml
{
	public class MiniParser
	{
		...
		public sealed class HandlerAdapter : IHandler
		{
		...
		public sealed class AttrListImpl : IMutableAttrList, IAttrList
		{
		...
		public sealed class XMLError : Exception
		{
		...
		public void Parse(IReader reader, IHandler handler)
		{
			...
			while (true)
			{
				...
				int num5 = Xlat(num4, num);
				num = num5 & 0xFF;
				if (num3 == 10 && (num == 14 || num == 15))
				{
					continue;
				}
				num5 >>= 8;
				if (num >= 128)
				{
					FatalErr((num == 255) ? "State dispatch error." : errors[num ^ 0x80]);
				}
				switch (num5)
				{
				case 9:
				...
				case 1:
				{
					...
					{
						FatalErr((text6 == null) ? "Tag stack underflow" : ("Expected end tag '" + text2 + "' but found '" + text6 + "'"));
					}
					handler.OnEndElement(text2);
					break;
				}
				...
				case 8:
					FatalErr(string.Format("Error {0}", num));
					break;
				case 10:
					stringBuilder = new StringBuilder();
					if (num3 == 60)
				...
				case 12:
					if (flag2)
					{
						if (num3 == 62 && twoCharBuff[0] == 45 && twoCharBuff[1] == 45)
						{
							flag2 = false;
							num = 0;
						}
				...
				case 13:
				{
					...
					if (num3 == 35)
					{
						...
						{
							int num10 = -1;
							if (char.IsNumber((char)num3) || "abcdef".IndexOf(char.ToLower((char)num3)) != -1)
							{
								try
								{
									num10 = int.Parse(new string((char)num3, 1), style);
								}
					...
					else
					{
						...
						while (true)
						{
							if (num11 != 15)
							{
								num11 = text3.IndexOf((char)num3) & 0xF;
							}
							if (num11 == 15)
							{
								FatalErr(errors[7]);
							...
							else if (num16 != 15 && num3 == text3[num16])
							{
								if (num18 < 14)
								{
									num12 = num18;
